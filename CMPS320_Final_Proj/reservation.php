                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="checkout-faqs wow fadeInUp" id="checkout-faq">
                            ...
                            <br><h3>Hi, <strong><?php echo htmlspecialchars($fname); ?></strong>.</h3>
                            <h3>You have made a reservation for <strong><?php echo htmlspecialchars($party); ?></strong> 
                                people on <strong><?php echo htmlspecialchars($date); ?></strong> at <strong><?php echo htmlspecialchars($time); ?></strong></h3>
                            <h3>Your booking details have been emailed to <strong><?php echo htmlspecialchars($email); ?></strong></h3>
                            <br><h3>We look forward to seeing you!</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
