                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Menu Details - Mystery Meat </h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/menu/mysterymeat.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">Mystery Meat</h4>
                                <p>We'll be honest, these ones scare us a bit. It's pretty much whatever meat we can find put between to pieces of bread. The Problem is we can't always identify the meat. To make up for this we put a thick slize off cheese in there, who doesn't love cheese?</p>
                                <span class="price"><span class="currency">$</span>0.99 </span>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <div class="content-box">
                                            <h3>Mystery Meat Burger</h3>
                                            <p>We'll be honest, these ones scare us a bit. It's pretty much whatever meat we can find shoved between two pieces of bread. The problem is... we can't always identify the meat. To make up for this, we added a thick slize of cheese — because who doesn't love cheese?</p>
                                        
                                            <h4>Ingredients:</h4>
                                            <ul class="check-list mb-30">
                                                <li>Unidentifiable "meat" (could be raccoon, could be office chair, or... the person in the basement- WHO SAID THAT)</li>
                                                <li>Thick slize of cheese with questionable origins</li>
                                                <li>Crumbs from a bun that probably expired in 2009</li>
                                                <li>Grease aged like fine wine</li>
                                                <li>Optional: hint of despair</li>
                                            </ul>
                                        
                                            <h4>Preparation:</h4>
                                            <ul class="check-list mb-30">
                                                <li>Scoop meat from the mystery pile behind the fridge</li>
                                                <li>Apply cheese using industrial glue (melting is optional)</li>
                                                <li>Drop on floor for that “seasoned” touch</li>
                                                <li>Wrap loosely in wax paper stolen from another restaurant</li>
                                                <li>Serve with a straight face and a waiver</li>
                                            </ul>
                                        </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="content-box">
                                            <div class="review-box">
                                                ...
                                                <div class="review-box mb-4">
                                                    ...
                                                    <p><strong>Gerald</strong>: “I bit into something crunchy... it blinked. Pretty sure it tried to fight me from the inside. Still better than my ex’s cooking.”</p>
                                                </div>
                                                ...
                                                <div class="review-box mb-4">
                                                    ...
                                                    <p><strong>Linda</strong>: “I don’t know what kind of meat that was, but it roared when I poked it. I respect that level of fight in a burger.”</p>
                                                </div>
                                                ...
                                                <div class="review-box mb-4">
                                                    ...
                                                    <p><strong>Chaz</strong>: “Tasted like fear and lost dreams. I’d give it zero stars if it didn’t come with a free coupon for therapy.”</p>
                                                </div>
                                                ...
                                                <div class="review-box mb-4">
                                                    ...
                                                    <p><strong>Rico</strong>: “Surprisingly flavorful… or maybe that was the hallucination. Either way, I saw God and he was concerned.”</p>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-bordered text-start w-100" style="max-width: 400px;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>1 questionable decision</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Calories</strong></td>
                                                            <td>789 (give or take a rat)</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>31g (mostly cheese?)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Cholesterol</strong></td>
                                                            <td>95mg (and deep concern)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Sodium</strong></td>
                                                            <td>2,800mg (legally concerning)</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>0g (fiber ran away)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Sugars</td>
                                                            <td>15g (likely from the cheese?)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Protein</strong></td>
                                                            <td>23g (unsure of source)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>“Meat” Content</strong></td>
                                                            <td>Unknown (we stopped asking)</td>
                                                        </tr>
                                                        <tr class="table-danger">
                                                            <td colspan="2" class="text-center"><em>*May cause meat sweats and identity crises*</em></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
