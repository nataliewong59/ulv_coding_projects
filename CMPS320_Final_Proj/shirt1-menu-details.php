                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Merch Details - Nastee Burger Logo T-Shirt</h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/merch/shirt1.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">Nastee Burger Logo T-Shirt</h4>
                                <p>Get ready to wear your love for the nastiest burger in town with this bold and unforgettable shirt. Featuring the iconic Nastee Burger logo, this shirt isn't just a piece of clothing—it's a statement. Whether you're out on a food adventure or just enjoying a casual day, this shirt serves up a double dose of attitude with a side of sass. Made from soft, comfortable fabric, it’s perfect for those who enjoy their burgers with a little extra bite. Wear it, love it, and let the world know you're all about the Nastee.</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <h2>Nastee Burger Logo T-Shirt</h2>
                                        <p>
                                            Loud, proud, and absolutely irresponsible—our <strong>Nastee Burger Logo Tee</strong> is here to make a greasy statement. Featuring the infamous Nastee Burger logo front and center, this shirt is perfect for fans of bold flavors and bolder fashion choices.
                                        </p>
                                        <ul class="feature-list">
                                            <li>Soft 100% pre-shrunk cotton for guilt-free comfort</li>
                                            <li>Unisex fit – sloppy enough for everyone</li>
                                            <li>Printed with high-quality ink that resists ketchup stains (no promises though)</li>
                                            <li>Double-stitched hems to survive food fights</li>
                                            <li>Available in sizes S to XXL (because Nastee doesn't judge)</li>
                                        </ul>
                                        <p class="note text-muted"><em>Pairs perfectly with Hairy Fries and low standards.</em></p>
                                    </div>
