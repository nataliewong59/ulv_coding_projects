                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Menu Details -  Hairy Fries</h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/menu/hairyfries.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">Hairy Fries</h4>
                                <p>Fries that are hairy... DELICIOUSSSSS</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <h3>Hairy Fries</h3>
                                        <p>Prepare yourself for the most adventurous side dish you’ll ever encounter: <strong>Hairy Fries</strong>. These fries come with an unexpected twist — and by twist, we mean a full-on mane of hair. We start with perfectly crispy fries, and then... well, we let nature take its course. Maybe it’s the fryer. Maybe it’s the fact that our kitchen has some very questionable air circulation. But one thing's for sure: you’ll never look at fries the same way again.</p>
                                        
                                        <h4>Ingredients:</h4>
                                        <ul class="check-list mb-30">
                                            <li>Crispy golden fries (with a touch of destiny)</li>
                                            <li>Hair (gently collected from various sources... don't ask)</li>
                                            <li>Secret seasoning (it’s probably garlic, but no promises)</li>
                                            <li>Oil, lots of oil (the greasier, the better)</li>
                                            <li>Optional: A pinch of rosemary to fool yourself into thinking it’s fancy</li>
                                        </ul>
                                        
                                        <h4>Preparation:</h4>
                                        <ul class="check-list mb-30">
                                            <li>Fry potatoes until they're crisp and full of regrets</li>
                                            <li>Let them cool in a place where hair is free to wander</li>
                                            <li>Sprinkle with seasoning, making sure the hair gets a little love too</li>
                                            <li>Serve in a basket that will leave your dignity in the fryer</li>
                                            <li>Optional: Add a sprig of rosemary and tell yourself it’s gourmet</li>
                                        </ul>
...
<li class="review-item mb-4">
    ...
    <p>"I thought I was biting into fries, but what I got was an uninvited hair experience. One star for the fries, minus one for the surprise protein addition. My dentist is going to love this one."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"The fries were fine, but the hair was... unexpected. A little extra texture, I suppose? I’m still chewing on it, literally and metaphorically."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"I’ve encountered some strange things in my time, but these Hairy Fries truly made me wonder if I was being haunted by a forgotten fast food chain. A bit hairy, a bit crispy. I’ll give it 3 stars for the boldness."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"I expected crispy fries, but what I got was a whole new level of ‘natural seasoning.’ The fries tasted fine, but I’m still working on my relationship with the hair." </p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"Hairy fries were a wild ride. It’s like eating fries and winning a bet with the universe. The fries were crispy, but that hair? It gave me a new outlook on life...and food hygiene."</p>
</li>
            ...
            <table class="table table-bordered text-start w-100" style="max-width: 400px;">
                <tbody>
                    <tr>
                        ...
                        <td>1 truly adventurous fry</td>
                    </tr>
                    <tr>
                        <td><strong>Calories</strong></td>
                        <td>650 (mostly from oil, regret, and existential dread)</td>
                    </tr>
                    <tr>
                        <td><strong>Total Fat</strong></td>
                        <td>30g (could be grease, could be hair oil... we're not sure)</td>
                    </tr>
                    <tr>
                        <td class="ps-4">Saturated Fat</td>
                        <td>12g (thanks to our very crispy, very questionable coating)</td>
                    </tr>
                    <tr>
                        <td><strong>Cholesterol</strong></td>
                        <td>80mg (you’re not supposed to eat hair, but here we are)</td>
                    </tr>
                    <tr>
                        <td><strong>Sodium</strong></td>
                        <td>1,150mg (salt and hair: the perfect pair)</td>
                    </tr>
                    <tr>
                        <td><strong>Total Carbohydrates</strong></td>
                        <td>45g (that’s the fries... and possibly some hair strands)</td>
                    </tr>
                    <tr>
                        <td class="ps-4">Dietary Fiber</td>
                        <td>3g (mostly from the unexpected hair texture)</td>
                    </tr>
                    <tr>
                        <td class="ps-4">Sugars</td>
                        <td>7g (sweetened by a touch of regret)</td>
                    </tr>
                    <tr>
                        <td><strong>Protein</strong></td>
                        <td>5g (hair...protein...just go with it)</td>
                    </tr>
                    <tr>
                        <td><strong>Hair Content</strong></td>
                        <td>Up to 3 strands (hand-placed for your pleasure)</td>
                    </tr>
                    <tr class="table-danger">
                        <td colspan="2" class="text-center"><em>*May cause irrational fear of hair in food, awkward stares, and questions about hygiene*</em></td>
                    </tr>
                </tbody>
            </table>
        </div>
