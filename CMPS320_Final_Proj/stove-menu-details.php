                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Menu Details - Stove Grease Grilled Cheese </h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/menu/stovegreasegrilledcheese.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">Stove Grease Grilled Cheese</h4>
                                <p>Now don't let this normal looking grilled cheese fool you. What we mean by Stove grease grilled, is that we literally cook it in all our stove's grease. So no matter what we were making on this thing before, there a little bit of everything on this sandwich. This leads to a unique flavor everytime.</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <p>Don’t be deceived by appearances — the <strong>Stove Grease Grilled Cheese</strong> is a culinary gamble cooked directly in our sacred, unwashed stove sludge. It’s a one-of-a-kind grease-aged sandwich infused with every regret we’ve ever seared. Each bite is a surprise. Will it taste like pancakes, fish sticks, or despair? You’ll never know until it’s too late.</p>

                                        <h4>Ingredients:</h4>
                                        <ul class="check-list mb-30">
                                            <li>Two slices of bread vaguely resembling sourdough</li>
                                            <li>Cheese blend™ (now legally not “cheese”)</li>
                                            <li>Residual stove grease from 30+ previous meals</li>
                                            <li>Burnt crust particles for “texture”</li>
                                            <li>A whisper of ash and hopelessness</li>
                                            <li>Optional: embedded fingernail (free of charge!)</li>
                                        </ul>
                                        
                                        <h4>Preparation:</h4>
                                        <ul class="check-list mb-30">
                                            <li>Do not clean stove. Ever.</li>
                                            <li>Shove sandwich into the hottest, oiliest section of pan</li>
                                            <li>Let grease do its dark work</li>
                                            <li>Flip once, or just think about flipping</li>
                                            <li>Serve with a napkin that’s already stained</li>
                                        </ul>
...
<li class="review-item mb-4">
    ...
    <p>"Tasted like regret and engine oil. I think I bit into someone’s old breakfast. Bold culinary choice."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"Each bite reminded me of a different meal I didn’t order. It’s like food-based time travel through bad life choices."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"Been haunting this stove for years. This sandwich finally honored my legacy of burnt offerings and despair. Bravo."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"I don’t know what I expected. My fork bent trying to cut it, and now my soul is slightly off balance."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"Tasted like pain and mystery. Honestly? Best grilled cheese I’ve ever had. The trauma adds flavor."</p>
</li>
                                                ...
                                                <table class="table table-bordered text-start w-100" style="max-width: 400px;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>1 burnt memory</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Calories</strong></td>
                                                            <td>911 (emergency only)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Total Fat</strong></td>
                                                            <td>52g (mostly grease)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Saturated Fat</td>
                                                            <td>37g (from the melted mystery block)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Cholesterol</strong></td>
                                                            <td>120mg (and climbing fast)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Sodium</strong></td>
                                                            <td>1,690mg (saltier than your ex)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Total Carbohydrates</strong></td>
                                                            <td>39g (mostly soot)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Dietary Fiber</td>
                                                            <td>0g (fiber not welcome here)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Sugars</td>
                                                            <td>11g (from caramelized despair)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Protein</strong></td>
                                                            <td>14g (if you count the crispy cheese)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Grease Residue</strong></td>
                                                            <td>∞g (eternal and binding)</td>
                                                        </tr>
                                                        <tr class="table-danger">
                                                            <td colspan="2" class="text-center"><em>*May cause vivid hallucinations and flashbacks to college dorm cooking*</em></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
