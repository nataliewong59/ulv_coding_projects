                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/merch/hat1.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">Neon Nastee Burger Bucket Hat</h4>
                                <p>Turn heads and protect your questionable decisions from the sun with the Neon Nastee Bucket Hat! Featuring our electric pink logo blazing like a diner sign at 2 a.m., this crisp white hat brings just the right amount of chaos to your outfit. Whether you're braving the summer heat or just hiding from your latest food regret, this hat’s got you covered—literally. Lightweight, breathable, and dripping with Nastee pride, it's the ultimate accessory for those who like their fashion a little unhinged and their branding extra bold.</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        ...
                                        <p>
                                            Top off your look with a glowing insult to good taste. The <strong>Neon Nastee Logo Bucket Hat</strong> features our iconic Nastee Burger logo in eye-searing neon pink, embroidered right on the front of a crisp white cotton canvas. It’s giving retro, fast food fever dream—with just a hint of regret.
                                        </p>
