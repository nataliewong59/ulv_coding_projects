                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Merch Details - "They Put WHAT in the Stick?" Shirt </h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/merch/shirt2.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title"> "They Put WHAT in the Stick?" Shirt</h4>
                                <p>Ever wondered what really goes into a Crud Stick? Now you can wear your curiosity with this bold and hilarious tee! Featuring the phrase "They Put WHAT in the Stick?" along with a quirky image of the infamous Crud Stick, this shirt is perfect for those who enjoy a good laugh and a little mystery. Whether you're into questionable snacks or just love a good food joke, this shirt will have everyone asking, "Wait, what did they put in there?" Soft, comfortable, and guaranteed to spark conversation, it’s the perfect addition to your collection of weird and wonderful merch.</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <h2>"They Put WHAT in the Stick?" T-Shirt</h2>
                                        <p>
                                            You asked the question. Now wear the mystery. The <strong>"They Put WHAT in the Stick?" Tee</strong> features an illustration of the infamous Crud Stick and enough attitude to scare a salad. It’s equal parts food fear and fashion flex.
                                        </p>
                                        <ul class="feature-list">
                                            <li>Made with 100% cotton (unlike the Crud Stick)</li>
                                            <li>Unisex cut with just the right amount of judgmental side-eye</li>
                                            <li>Vibrant full-color print of the Crud Stick you love/hate</li>
                                            <li>Great conversation starter or ender</li>
                                            <li>Sizes available from S to XXL – because curiosity comes in all shapes</li>
                                        </ul>
                                        <p class="note text-muted"><em>Warning: May attract concerned nutritionists and confused relatives.</em></p>
                                    </div>
