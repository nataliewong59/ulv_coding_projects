...
<html lang="zxx">
    ...
    <div class="sidemenu-content">
        ...
        <!--====== Start Page Section ======-->
        <section class="intro-section pt-125">
            <div class="container">
                <div class="intro-wrapper_two">
                    <div class="row">
                        <div class="col-lg-6">
                            <!--=== Text Box ===-->
                            <div class="text-box mb-50 wow fadeInLeft">
                                <h3>NASTEE Burger was founded in the summer of '87 by Nash Flanigan.</h3>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Text Box ===-->
                            <div class="text-box mb-50 wow fadeInRight">
                                <p>Nash was known by many in the neighborhood as the neighborhood jokester. There wasn't a moment where Nash wasn't around toher craking jokes and making others laugh. Nash was also known for his love of cooking, spending most of his time at his job working at his local diner. One day to mess with one of his friends Nash decided to make a horrendously nasty Burger. To him and his friend his was hilarious. That's when he had the idea. What if he opened up a gimmick restraunt where they intentionally sold nasty food.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--====== Start Team Section ======-->
        <section class="team-section pt-110 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <!--=== Section Title ===-->
                        <div class="section-title text-center mb-55 wow fadeInDown">
                            <h2>Meet our Founder chef</h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <!--=== Team Item ===-->
                        <div class="team-item style-two mb-40 wow fadeInUp" data-wow-delay=".35s">
                            <div class="member-image">
                                <img src="assets/images/team/founder.jpg" alt="Member Image">
                            </div>
                            <div class="member-info">
                                <h4 class="title">Nash Flanigan. </h4>
                                <span class="position">Founder of Nastee Burger</span>
