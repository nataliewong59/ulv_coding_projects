...
<html lang="zxx">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Menu Details - The Original NASTEE Burger </h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/menu/ognastee.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">The Original NASTEE Burger</h4>
                                ...
                                <span class="price"><span class="currency">$</span>100 <span class="pre-price"><span class="currency">$</span>1500.00</span></span>
    ...
    <p>Sink your teeth into the **Original NASTEE Burger** – the monstrosity that started it all. This classic cheese burger is proudly covered in hand-curated mold and soaked in our signature *secret slime sauce*. It even comes with a complimentary rat (name it if you survive)!</p>

    <h4>Ingredients:</h4>
    <ul class="check-list mb-30">
        <li>Beef(?) patty with a mysterious green fuzz</li>
        <li>Day-old cheese that screams when touched</li>
        <li>“Fresh” mold scraped from the back of the fridge</li>
        <li>Secret slime sauce (don’t ask what's in it)</li>
        <li>A side of pre-owned lettuce</li>
        <li>One free rat (while supplies last)</li>
    </ul>

    <h4>Preparation:</h4>
    <ul class="check-list mb-30">
        <li>Slap everything together with minimal care</li>
        <li>Leave under a heat lamp until emotions fade</li>
        <li>Optional: blow a kiss to the rat for good luck</li>
        <li>Serve on a cracked tray for that authentic NASTEE™ vibe</li>
    </ul>
</div>
                                    </div>
                                            ...
                                            <div class="review-box">
                                                ...
                                                <ul class="review-list">
                                                    ...
                                                    <li class="review-item mb-4">
                                                        ...
                                                        <p>"I bit into the burger and immediately remembered every bad decision I’ve ever made. 10/10 would regret again."</p>
                                                    </li>
                                                    ...
                                                    <li class="review-item mb-4">
                                                        ...
                                                        <p>"The secret slime sauce dripped on my shirt and now I think it’s alive. Burger was cold, but emotionally scarring."</p>
                                                    </li>
                                            
                                                    <!-- Review 3 -->
                                                    <li class="review-item mb-4">
                                                        <div class="review-header">
                                                            <strong>Dennis the Rat</strong>
                                                            <div class="star-rating">
                                                                <i class="fas fa-star text-warning"></i>
                                                                <i class="fas fa-star text-warning"></i>
                                                                <i class="fas fa-star text-warning"></i>
                                                        ...
                                                        <p>"As the complimentary rat, I give this burger two paws up. Finally, a place that serves <em>real trash</em>."</p>
                                                    </li>
                                                    ...
                                                    <li class="review-item mb-4">
                                                        ...
                                                        <p>"Got violently ill. But on the bright side, I lost 10 pounds in 3 hours. Thanks NASTEE Burger!"</p>
                                                    </li>
                                            
                                                    <!-- Review 5 -->
                                                    <li class="review-item mb-4">
                                                        <div class="review-header">
                                                            <strong>Trevor B.</strong>
                                                            <div class="star-rating">
                                                                <i class="fas fa-star text-warning"></i>
                                                                <i class="fas fa-star text-warning"></i>
                                                                <i class="fas fa-star text-warning"></i>
                                                        ...
                                                        <p>"It’s not food. It’s performance art. I cried. My date cried. We’re married now."</p>
                                                    </li>
                                                ...
                                                <table class="table table-bordered text-start w-100" style="max-width: 400px;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>90mg (and rising)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Sodium</strong></td>
                                                            <td>1,250mg (we stopped counting)</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>1g (from the bun mold)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Sugars</td>
                                                            <td>19g (mystery origin)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Protein</strong></td>
                                                            <td>20g (plus 5g from the rat)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Secret Slime Sauce</strong></td>
                                                            <td>???g (classified)</td>
                                                        </tr>
                                                        <tr class="table-danger">
                                                            <td colspan="2" class="text-center"><em>*May cause emotional damage and temporary blindness*</em></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
