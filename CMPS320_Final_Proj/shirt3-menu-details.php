                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Merch Details - Vintage Nastee Burger Shirt </h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/merch/NASTEEMerch1.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title"> Vintage Nastee Burger Shirt</h4>
                                <p>Take a delicious bite of nostalgia with the Vintage Nastee Burger shirt! Featuring the iconic design showcasing the original Nastee Burgers in all their greasy glory, this shirt pays homage to the burger joint that started it all. The retro-style artwork brings you back to the good ol' days when burgers were messy, questionable, and so satisfying. Whether you were there for the very first bite or you're just a fan of the legendary Nastee Burger lore, this shirt is a must-have for any fan of offbeat food culture. Soft, vintage-washed fabric ensures comfort, while the design serves up a hearty helping of history. Wear it and let everyone know you’ve got taste... questionable as it may be!</p>
                                <span class="price"><span class="currency">$</span>24.99 <span class="pre-price"><span class="currency">$</span>50.00</span></span>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <h2>Vintage Nastee Burger T-Shirt</h2>
                                        <p>
                                            A blast from the barely-regulated past. The <strong>Vintage Nastee Burger Tee</strong> pays homage to the original disaster that started it all, featuring the very first two Nastee Burgers ever created (and possibly still alive). Printed with a retro vibe that screams nostalgia and indigestion.
                                        </p>
                                        <ul class="feature-list">
                                            <li>Classic fit, vintage-styled cotton blend</li>
                                            <li>Retro Nastee Burger artwork from the vault of bad decisions</li>
                                            <li>Soft-washed for a lived-in feel (not to be confused with being pre-greased)</li>
                                            <li>Available in sizes S to XXL for every kind of vintage soul</li>
                                            <li>Perfect for collectors, weird food fans, and time travelers from 1984</li>
                                        </ul>
                                        <p class="note text-muted"><em>Because some things age like fine wine—and others like Nastee Burgers.</em></p>
                                    </div>
