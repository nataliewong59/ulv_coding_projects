                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center mb-55 wow fadeInDown">
                            <h1>Buy Merch!</h1>
                            <p>Indulge in an array of meticulously crafted merchandise!</p>
                        <br><br>
                            <h2>Shirts</h2>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="menu-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/merch/NASTEEMerch1.png" alt="Image">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="menu-item-list">
                            <div class="menu-item style-three mb-30 wow fadeInUp">
                                <div class="menu-thumbnail">
                                    <img src="assets/images/merch/shirt1.png" alt="Menu Thumbnail">
                                </div>
                                <div class="menu-info">
                                    <h4 class="title"><a href="shirt1-menu-details.php">Logo Shirt</a></h4>
                                    <p>Get ready to wear your love for the nastiest burger in town with this bold and unforgettable shirt. </p>
                                    <p class="price"><span class="currency">$</span>24.99</p>
                                </div>
                            </div>
                            <div class="menu-item style-three mb-30 wow fadeInUp">
                                <div class="menu-thumbnail">
                                    <img src="assets/images/merch/shirt2.png" alt="Menu Thumbnail">
                                </div>
                                <div class="menu-info">
                                    <h4 class="title"><a href="shirt2-menu-details.php">"They Put WHAT in the Stick?" Shirt</a></h4>
                                    <p>Ever wondered what really goes into a Crud Stick? Now you can wear your curiosity with this bold and hilarious tee!</p>
                                    <p class="price"><span class="currency">$</span>24.99</p>
                                </div>
                            </div>
                            <div class="menu-item style-three mb-30 wow fadeInUp">
                                <div class="menu-thumbnail">
                                    <img src="assets/images/merch/NASTEEMerch1.png" alt="Menu Thumbnail">
                                </div>
                                <div class="menu-info">
                                    <h4 class="title"><a href="shirt3-menu-details.php">Vintage Nastee Burger</a></h4>
                                    <p>Take a delicious bite of nostalgia with the Vintage Nastee Burger shirt!</p>
                                    <p class="price"><span class="currency">$</span>24.99</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="menu-item-list">
                            <div class="menu-item style-three mb-30 wow fadeInUp">
                                <div class="menu-thumbnail">
                                    <img src="assets/images/merch/hat1.png" alt="Menu Thumbnail">
                                </div>
                                <div class="menu-info">
                                    <h4 class="title"><a href="neon-menu-details.php">NEON Nastee Burger Bucket Hat</a></h4>
                                    <p>Turn heads and protect your questionable decisions from the sun with the Neon Nastee Bucket Hat!</p>
                                    <p class="price"><span class="currency">$</span>20.00</p>
                                </div>
                            </div>
                            <div class="menu-item style-three mb-30 wow fadeInUp">
                                <div class="menu-thumbnail">
                                    <img src="assets/images/merch/hat2.png" alt="Menu Thumbnail">
                                </div>
                                <div class="menu-info">
                                    <h4 class="title"><a href="classic-menu-details.php">Classic Nastee Bucket Hat</a></h4>
                                    <p>Keep it clean while staying unreasonably bold. The Classic Nastee Bucket Hat features our OG Nastee Burger logo smack in the center.</p>
                                    <p class="price"><span class="currency">$</span>20.00</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="menu-image-box mb-50 wow fadeInRight">
                            <img src="assets/images/merch/hat1.png" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
