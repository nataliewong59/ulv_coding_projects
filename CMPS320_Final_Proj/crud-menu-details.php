                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner-content text-center">
                                <h1 class="page-title">Menu Details - Crud Sticks </h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="menu-image mb-50 wow fadeInLeft">
                                <img src="assets/images/menu/crudsticks.png" alt="Product Image">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Menu Info ===-->
                            <div class="menu-info-content mb-50 wow fadeInRight">
                                <h4 class="title">Crud Sticks</h4>
                                <p>This is our vegan friendly option!. It may look like a pickle but it's a bunch of randomly picked green vegatables we grabbed, compacted together, and skewed on a stick. Then we dip them in vinegar, and bang! Crud Sticks.</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="cat1">
                                       <div class="content-box">
                                        <h3>Crud Sticks</h3>
                                        <p>Introducing our “vegan-friendly” favorite: <strong>Crud Sticks</strong>! They might resemble pickles, but trust us — they’re not. We grabbed whatever green vegetables were left in the bottom of the bin, mashed them together, and jammed them onto a stick. Then we dunk the whole mess in vinegar and call it innovation. Voila! Crud Sticks.</p>
                                        
                                        <h4>Ingredients:</h4>
                                        <ul class="check-list mb-30">
                                            <li>Mystery green vegetables (hand-selected by someone with questionable judgment)</li>
                                            <li>Vinegar (aged 3 days in a mop bucket)</li>
                                            <li>A touch of dirt (for authenticity)</li>
                                            <li>Skewers that may or may not be dishwasher safe</li>
                                            <li>Optional: spritz of lemon to pretend it's refreshing</li>
                                        </ul>
                                        
                                        <h4>Preparation:</h4>
                                        <ul class="check-list mb-30">
                                            <li>Forage through the fridge for green things past their prime</li>
                                            <li>Compact vegetables using a suspiciously clean boot</li>
                                            <li>Skewer aggressively while questioning your life choices</li>
                                            <li>Dip in vinegar until slightly translucent and fully offended</li>
                                            <li>Wave over an open flame (optional and mostly theatrical)</li>
                                            <li>Serve on a paper plate that disintegrates on contact</li>
                                        </ul>
...
<li class="review-item mb-4">
    ...
    <p>"One bite in and I swear I saw the ghost of a cucumber. Crunch level: threatening. My gums are still recovering."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"There’s something bold about vegetables that fight back. I think one of them blinked at me. 5 stars for bravery."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"I don't eat much, being a stove ghost, but Crud Sticks spoke to me. Possibly cursed, definitely vinegary. Not bad."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"My Crud Stick tried to escape the plate. I respect that. Flavor-wise, it’s like licking a salad’s evil twin."</p>
</li>
...
<li class="review-item mb-4">
    ...
    <p>"Surprisingly invigorating. Like if a compost bin got its life together and started a food truck. Would order again."</p>
</li>
                                                ...
                                                <table class="table table-bordered text-start w-100" style="max-width: 400px;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>3 unsettling sticks</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Calories</strong></td>
                                                            <td>420 (blaze it... in vinegar)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Total Fat</strong></td>
                                                            <td>22g (some of it might be from expired ranch mist)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Saturated Fat</td>
                                                            <td>10g (thanks to the mysterious "dip residue")</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Cholesterol</strong></td>
                                                            <td>75mg (egg whisper optional)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Sodium</strong></td>
                                                            <td>980mg (each pickle stick signed a salt pact)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Total Carbohydrates</strong></td>
                                                            <td>37g (if you count the breadcrumbs and mystery flakes)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Dietary Fiber</td>
                                                            <td>2g (if you survive the crunch)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-4">Sugars</td>
                                                            <td>5g (nature’s apology)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Protein</strong></td>
                                                            <td>6g (from the veggies... allegedly)</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Glass Content</strong></td>
                                                            <td>0 shards (finally, a win!)</td>
                                                        </tr>
                                                        <tr class="table-danger">
                                                            <td colspan="2" class="text-center"><em>*May cause sudden crunch anxiety, brine hallucinations, and haunting flashbacks to your last county fair*</em></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
