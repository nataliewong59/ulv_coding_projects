...
<html lang="zxx">
    ...
    <div class="sidemenu-content">
        ...
        <!--====== Start Faqs Section ======-->
        <section class="faqs-section pt-120 pb-115 gray-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <!--===  Section Title  ===-->
                        <div class="section-title text-center mb-55 wow fadeInDown">
                            ...
                            <p>We know that our franchise is a bit unconventional, and that tends to raise questions. That's why we have this page to answer the most Frequently Asked Questions we've been asked over the years.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6" style="width: 75%;; padding-left: 25%;" >
                        <!--=== Accordion ===-->
                        <div class="accordion wow fadeInUp" id="accordionOne">
                            <!--=== Accordion Item ===-->
                            <div class="accordion-card style-one mb-15 wow fadeInDown">
                                <div class="accordion-header">
                                    <h6 class="accordion-title" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false">
                                        What are the burgers really made of?
                                    </h6>
                                </div>
                                <div id="collapse1" class="accordion-collapse collapse" data-bs-parent="#accordionOne">
                                    <div class="accordion-content">
                                        <p>This varies from burger to burger but most of the time everything you see that seems off is purely cosmetic. We use an array of different ingredients to pull off these off putting meals.</p>
                                    </div>
                                </div>
                            </div>
                            <!--=== Accordion Item ===-->
                            <div class="accordion-card style-one mb-15 wow fadeInDown">
                                <div class="accordion-header">
                                    <h6 class="accordion-title" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true">
                                        Are these safe to eat?
                                    </h6>
                                </div>
                                <div id="collapse2" class="accordion-collapse collapse show" data-bs-parent="#accordionOne">
                                    <div class="accordion-content">
                                        <p>Of course, everything we make is designed to be laughed at, eaten, and enjoyed. We are Health Department ceritified.</p>
                                    </div>
                                </div>
                            </div>
                            <!--=== Accordion Item ===-->
                            <div class="accordion-card style-one mb-15 wow fadeInDown">
                                ...
                                <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#accordionOne">
                                    <div class="accordion-content">
                                        <p>Comedy is subjective, and it's ok if you don't find trash on a tray funny. And even if you don't find this funny, our 12 different nation wide locations would disagree with you ;)</p>
                                    </div>
                                </div>
                            </div>
